/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --env-file=.env.example src/worker-configuration.d.ts` (hash: 09def074998394e69e92f4287c42d730)
// Runtime types generated with workerd@1.20260730.1 2026-03-01 nodejs_compat
interface __BaseEnv_Env {
	...
	ENVIRONMENT: string;
	AUTH_TOKEN: string;
	BACKEND_CALLBACK_TOKEN: string;
	BACKEND_ORIGIN: string;
	WORKFLOW_BINDING_NAME: string;
	BACKEND: Fetcher /* manhali-api-sandbox */ | Fetcher /* manhali-api-production */;
...
declare namespace Cloudflare {
	...
	interface SandboxEnv {
		...
		BACKEND_ORIGIN: string;
		WORKFLOW_BINDING_NAME: string;
		BACKEND: Fetcher /* manhali-api-sandbox */;
		WORKFLOW: Workflow<Parameters<import("./index").BackendCallbackWorkflow['run']>[0]['payload']>;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "AUTH_TOKEN" | "BACKEND_CALLBACK_TOKEN" | "BACKEND_ORIGIN" | "WORKFLOW_BINDING_NAME">> {}
}
declare module "*.wasm" {
